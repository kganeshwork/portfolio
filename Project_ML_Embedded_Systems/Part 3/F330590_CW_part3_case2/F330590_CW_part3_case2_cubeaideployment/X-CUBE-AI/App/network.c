...
#define AI_NETWORK_MODEL_SIGNATURE     "0x46f884c2cfb28833823fb1ae597fc8fe"
...
#define AI_TOOLS_DATE_TIME   "2026-04-30T18:19:50+0100"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 48, 32, 1, 1), AI_STRIDE_INIT(4, 4, 192, 6144, 6144),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 13060, 1, 1),
    13060, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor0_output_array.data = AI_PTR(g_network_activations_map[0] + 124);
    serving_default_keras_tensor0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 124);
    ...
    nl_2_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 128);
    nl_2_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 128);
    ...
    nl_3_nl_output_array.data = AI_PTR(g_network_activations_map[0] + 64);
    nl_3_nl_output_array.data_start = AI_PTR(g_network_activations_map[0] + 64);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 6528);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 6528);
    ...
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 10752);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 10752);
    gemm_3_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_weights_array.data = AI_PTR(g_network_weights_map[0] + 10880);
    gemm_3_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 10880);
    gemm_3_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_3_bias_array.data = AI_PTR(g_network_weights_map[0] + 12928);
    gemm_3_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 12928);
    gemm_4_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_4_weights_array.data = AI_PTR(g_network_weights_map[0] + 12992);
    gemm_4_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 12992);
    gemm_4_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_4_bias_array.data = AI_PTR(g_network_weights_map[0] + 13056);
    gemm_4_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 13056);
    return true;
  }
