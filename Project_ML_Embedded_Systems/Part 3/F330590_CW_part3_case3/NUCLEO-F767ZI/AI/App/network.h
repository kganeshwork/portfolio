...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "sine_model"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x25cf8979ad50b3a6e49ccb92038e38bc"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x36234fb24da83766)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,1}
#define STAI_NETWORK_IN_1_BATCH       (1)
#define STAI_NETWORK_IN_1_CHANNEL     (1)
#define STAI_NETWORK_IN_1_RANK        (1)
#define STAI_NETWORK_IN_1_SIZE        (1)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (4)
...
#define STAI_NETWORK_ACTIVATIONS_SIZE              (320)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (320)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (320)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (320)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (13060)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (13060)
#define STAI_NETWORK_WEIGHTS_ALIGNMENTS \
  { 4,4,4,4,4,4,4,4,4,4}
#define STAI_NETWORK_WEIGHTS_SIZES \
  { 192,192,6144,128,4096,128,2048,64,64,4}
#define STAI_NETWORK_WEIGHTS_NUM        (10)
#define STAI_NETWORK_WEIGHT_1_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_1_SIZE        (192)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (192)
#define STAI_NETWORK_WEIGHT_2_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_2_SIZE        (192)
#define STAI_NETWORK_WEIGHT_2_SIZE_BYTES  (192)
#define STAI_NETWORK_WEIGHT_3_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_3_SIZE        (6144)
#define STAI_NETWORK_WEIGHT_3_SIZE_BYTES  (6144)
...
#define STAI_NETWORK_WEIGHT_5_SIZE        (4096)
#define STAI_NETWORK_WEIGHT_5_SIZE_BYTES  (4096)
...
#define STAI_NETWORK_WEIGHT_7_SIZE        (2048)
#define STAI_NETWORK_WEIGHT_7_SIZE_BYTES  (2048)
...
#define STAI_NETWORK_WEIGHT_9_SIZE        (64)
#define STAI_NETWORK_WEIGHT_9_SIZE_BYTES  (64)
#define STAI_NETWORK_WEIGHT_10_FLAGS       ((STAI_FLAG_PREALLOCATED))
#define STAI_NETWORK_WEIGHT_10_SIZE        (4)
#define STAI_NETWORK_WEIGHT_10_SIZE_BYTES  (4)
