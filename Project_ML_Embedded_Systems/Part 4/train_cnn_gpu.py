...
def run_epoch(model, loader, criterion, optimizer=None, device="cpu", scaler=None):
...
def main():
    ...
    ap.add_argument("--out", type=str, default="runs_gpu")
    ap.add_argument(
        "--classes",
        nargs="+",
        default=["circlepolis", "rectanglepolis"],
